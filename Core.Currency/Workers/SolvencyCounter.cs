...
namespace Core.Currency.Workers
{
    public static class SolvencyCounter
    {
        ...
        private static int GetSolvencyValueOfTransaction(CurrencyContext context, Guid transactId, byte[] userPublicKey)
        ...
        private static VisitedTransact CreateVisitedTransact(CurrencyContext context, Guid sourseId, Wave wave, Guid? visitedByUserId = null)
        {
        ...
        private static Wave ResearchTransactChain(CurrencyContext context, Guid userId, Guid fId, Guid sId)
        {
